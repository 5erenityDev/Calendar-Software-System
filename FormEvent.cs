    ...
    public partial class EventForm : Form
    {
        ...
        private void btnEveViewEdit_Click(object sender, EventArgs e)
        {
            ...
            if (lBoxEveView.SelectedIndex >= 0)
            {
                ...
                string longDate = lBoxEveView.SelectedItem.ToString().Substring(dateBegin, (lBoxEveView.SelectedItem.ToString().IndexOf("	-")-dateBegin));
                string shortDate = lBoxEveView.SelectedItem.ToString().Substring(dateBegin, dateEnd+5);
                Console.WriteLine("The starting short date is " + shortDate);
                editedEvent.deleteEvent(thisCalendar, longDate, shortDate, name);
                // Set initial panel visibility
                panelEveView.Visible = false;
                panelEveAdd.Visible = true;
        ...
        private void btnEveViewDelete_Click(object sender, EventArgs e)
        {
            ...
            if (lBoxEveView.SelectedIndex >= 0)
            {
                ...
                string shortDate = lBoxEveView.SelectedItem.ToString().Substring(dateBegin, dateEnd+5);
                Console.WriteLine("The starting short date is " + shortDate);
                Console.WriteLine("The starting long date is " + longDate);
                Console.WriteLine("The starting title is " + name);
                deletedEvent.deleteEvent(thisCalendar, longDate, shortDate, name);
            }
        }
